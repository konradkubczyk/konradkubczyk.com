...
export const Hero = () => (
  <>
    ...
    <div className="z-10 flex flex-1 flex-col items-center justify-between gap-20 bg-gradient-to-b from-neutral-200/40 from-80% to-neutral-200 dark:from-neutral-950/75 dark:to-neutral-950">
      <div className="h-14" />
      <div className="mt-14 grid w-full max-w-screen-xl gap-5 px-5 md:grid-cols-2">
        <div className="flex flex-col gap-5">
          ...
          <p>
            I am a creative, open-minded and motivated person. My experience in
            web and software development is complemented by an eye for design
            and eagerness to innovate while solving problems.
          </p>
        </div>
        <div />
      </div>
